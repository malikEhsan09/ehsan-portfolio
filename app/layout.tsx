...
const options = {
  title: "Ehsan Ahmed | Software Developer",
  description:
    "Ehsan Ahmed is a Frontend Developer and Full Stack Engineer who is passionate about building solutions and contributing to open source communities",
